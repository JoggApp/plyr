...
| `preload`            | string                     | `true`                                                                                                                              | The preload attribute specifies if and how the video should be loaded when the page loads.                                                                                                                                                                                                                                                                                                              |
...
| `editor`             | Object                     | `{ enabled: false, target: '', controls: {target: ''} }`                                                                            | `enabled`: Whether to enable the video editor. `target`: The HTMLElement or string selector for the editor and editor controls target container. If no target is specified, it will be added to the video container.                                                                                                                                                                                    |
| `trim`               | Object                     | `{ enabled: false, closeEditor: true, maxTrimLength: -1, offsetContainer: false, zoom: {enabled: false, preRoll: 0, postRoll: 0} }` | `enabled`: Whether to enable the video trimming tool. `closeEditor`: On exit of the trimming tool should the editor be exited. `maxTrimLength`: Specify a maximum trimming length in seconds. `offsetContainer`: When inserting the trimming window, set the current time to be the mid point. The `zoom` object determines whether to zoom the timeline to the trimming when it is opened.             |
| `markers`            | Object                     | `{ enabled: false, lockToTrimRegion: true, lowerBound: -1, upperBound: -1}`                                                         | `enabled`: Whether to enable the video markers tool. `lockToTrimRegion`: If the trimming region is present prevent adding markers outside of the trimming window. `lowerBound`: Set the maximum lowerbound time of the trimming window. `upperBound`: Set the maximum upperBound time of the trimming window.                                                                                           |
...
| `editor.enter()`           | -                | Enter Editor tool.                                                                                         |
| `editor.exit()`            | -                | Exit Editor tool.                                                                                          |
| `editor.toggle()`          | -                | Toggle Editor tool.                                                                                        |
| `trim.enter()`             | -                | Enter Trimming tool.                                                                                       |
| `trim.exit()`              | -                | Exit Trimming tool.                                                                                        |
| `trim.toggle()`            | -                | Toggle Trimming tool.                                                                                      |
| `marker.addMarker()`       | String, Number,  | Add marker Tool.                                                                                           |
| `marker.removeMarker()`    | String           | Remove marker Tool.                                                                                        |
| `marker.removerMarkers()`  |                  | Remove all markers.                                                                                        |
...
| `entereditor`    | Sent when the player enters the editor tool.                                                                                                                                                                                                                                                                                                   |
| `exiteditor`     | Sent when the player exits the editor tool mode.                                                                                                                                                                                                                                                                                               |
| `entertrim`      | Sent when the player enters the trimming tool.                                                                                                                                                                                                                                                                                                 |
| `exittrim`       | Sent when the player exits the trimming tool mode.                                                                                                                                                                                                                                                                                             |
| `trimchanging`   | Sent when the trimming region is changing.                                                                                                                                                                                                                                                                                                     |
| `trimchange`     | Sent when the trimming region has changed.                                                                                                                                                                                                                                                                                                     |
| `markeradded`    | Sent when a new marker has been added to the timeline.                                                                                                                                                                                                                                                                                         |
| `markerchange`   | Sent when a markers position is changed.                                                                                                                                                                                                                                                                                                       |
